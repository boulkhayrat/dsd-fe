...
function searchOrders(user, description,reference, status) {
...
function editOrder(user, orderId, updatedOrder) {
  return instance.put(`/api/orders/${orderId}`, updatedOrder, {
    headers: {
      'Content-type': 'application/json',
      'Authorization': bearerAuth(user)
    }
